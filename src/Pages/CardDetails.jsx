...
const CardDetails = () => {
    ...
    const {title, companyName, description,reviews,ratingAvg, downloads} = card || {}
        ...
        <div className='flex items-center gap-2 '>
            ...
            <div className='right'>
                <div className='pb-10'>
                    ...
                    <h1 className='text-[10px]'>Developed by <span className='text-[#632EE3]'>{companyName}</span></h1>
                ...
                <div className='flex justify-between items-center gap-2'>
                   ...
                   <div>
                    ...
                    <div>
                        <img src={review} alt="" />
                        <h1>Total Reviews</h1>
                        <h1 className='text-3xl font-bold'>{reviews}<span>K</span></h1>
                    </div>

                </div>
                 <div className={`mt-10 text-white font-bold`}>
                   <button disabled={!state} onClick={() => handleInstall()} className='bg-[#00d390] p-2 '>{ state? "Install Now" : "Installed"}</button>
                </div>
